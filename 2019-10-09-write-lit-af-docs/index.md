...
![It's not blood. Honest.](hand-writing-docs.png)
...
![They don't have to be pretty on the first run through.](rough-diagram.png)
...
![The only downside to handwriting is copying it into a texteditor and not being able to type.](grammarly.png)
