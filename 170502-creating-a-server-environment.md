...
We're going to walkthrough how to set up a LAMP stack from scratch, install and further dependencies for DKAN, and set everything up for actually installing the platform.

## Contents
1. [Choosing your Server](#choosing-your-server)
1. [Installing a LAMP Stack](#installing-a-lamp-stack)
	1. [Manual Install](#manual-install)
	1. [Pre-built Stacks](#pre-built-stacks)

---

<a name="choosing-your-server"></a>
...
<a name="installing-a-lamp-stack"></a>
...
1. Update the available packages on your system, and install `apache2`:
...
## Moving On
Now that we've got our server environment set up, let's jump straight into [installing DKAN on the server](#)